  ...
  return (
    <>
      <div className="ace-glass overflow-hidden group transition-all duration-[250ms] ease-out hover:-translate-y-2 hover:shadow-[0_16px_48px_rgba(59,130,246,0.20)] hover:border-ace-electric/30 shadow-ace-card relative">
        <div className="group relative aspect-square bg-ace-black flex items-center justify-center">
          <div className="absolute top-3 right-3 z-20"><TrustBadge>{badge}</TrustBadge></div>
              ...
              {isMulti && (
                <>
                  <button
                    ...
                    className="absolute left-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-ace-black/70 border border-ace-glass-border flex items-center justify-center text-ace-white opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity"
                  >
                    <ChevronLeft size={16} />
                  </button>
                  <button
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-ace-black/70 border border-ace-glass-border flex items-center justify-center text-ace-white opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity"
                  >
