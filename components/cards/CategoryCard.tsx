...
export default function CategoryCard({ title, count, href, emoji }: { title: string, count: string, href: string, emoji?: string }) {
  ...
  return (
    <Comp {...props} className="ace-glass p-8 min-h-[280px] md:min-h-[320px] flex flex-col justify-between group transition-all duration-[250ms] ease-out hover:-translate-y-1 hover:shadow-ace-glow-strong hover:border-ace-electric/30 block">
      <div>
