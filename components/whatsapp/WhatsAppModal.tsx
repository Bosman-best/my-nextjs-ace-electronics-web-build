...
export default function WhatsAppModal({ open, onClose }: { open: boolean, onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="wa-modal-title">
      ...
      <div ref={cardRef} className="relative w-full max-w-[420px] rounded-2xl border border-ace-glass-border p-6 xs:p-8 md:p-10 text-center bg-white shadow-ace-glow-strong">
        ...
        <div className="mx-auto my-6">
          <Image src="/ace-whatsapp-qr.png" alt="WhatsApp QR code for ACE Electronics – scan to chat at wa.me/233547981348" width={180} height={180} className="mx-auto rounded-xl bg-white p-3 border border-ace-glass-border w-full max-w-[180px] h-auto aspect-square" />
        </div>
